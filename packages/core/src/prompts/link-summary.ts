  ...
  const slideInstruction =
    slides && slides.count > 0
      ? [
          ...
          'For each slide tag, start the segment with a short title line using this format: Title: Short headline.',
          'Do not include slide numbers or timestamps in the title line.',
